== RXE.26 - Give Strength Units (CWE)

[segment-definition]
Use when _RXE-2-Give Code_ does not specify the strength. This is the unit of the strength, used in combination with _RXE-25-Give Strength_. Refer to Table 0723 - Give Strength Units in Chapter 2C for valid values.
