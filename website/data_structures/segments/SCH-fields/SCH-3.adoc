...
[segment-definition]
This field is used in conjunction with _SCH-1-Placer Appointment ID_ and/or _SCH-2-Filler Appointment ID_ to uniquely identify an individual occurrence (a child) of a parent repeating schedule appointment.
