...
{{v2-table:0256:Time Delay Post Challenge}} in Chapter 2C, Code Tables, lists possible values for time delay.
...
We denote the route of the challenge via abbreviations for medication routes (see Chapter 4A, section 4A.4.2.1, "Route," which references {{v2-table:0162:Route of Administration}} in Chapter 2C, Code Tables). An oral route of administration would be denoted by "PO," an intravenous route by "IV."
...
The nature of a physiologic (non-drug) challenge may also be specified, using the terms in {{v2-table:0257:Nature of challenge}} in Chapter 2C, Code Tables.
