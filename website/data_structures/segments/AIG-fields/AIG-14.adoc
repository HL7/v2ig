== AIG.14 - Filler Status Code (CWE)

[segment-definition]
This field contains a code that describes the requested/scheduled status of scheduling resource or activity, from the point of view of the filler application. Refer to {{v2-table:0278:Filler Status Codes}} for suggested codes.
