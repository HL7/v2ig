== IN1.43 - Insured's Administrative Sex (CWE)

[segment-definition]
This field contains the gender of the insured. Refer to {{v2-table:0001:Administrative Sex}}_ in Chapter 2C, Code Tables, for suggested values.
