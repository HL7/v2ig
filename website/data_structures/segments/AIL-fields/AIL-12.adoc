== AIL.12 - Filler Status Code (CWE)

[segment-definition]
This field contains a code that describes the requested/scheduled status of the location, from the point of view of the filler application. Refer to {{v2-table:0278:Filler Status Codes}} in Chapter 2C, Code Tables, for suggested values.
