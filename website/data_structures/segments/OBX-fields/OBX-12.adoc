== OBX.12 - Effective Date of Reference Range (DTM)

[segment-definition]
This field contains the date (and, optionally, the time) on which the values in _OBX-7-reference range_ went into effect.
