...
[segment-definition]
This field contains the continuous, numerically valued tests/observations, with a nature code of A or C (see _OM1-18 - Nature of Service/Test/Observation_). This is a factor for converting the customary units to SI units.
