...
[segment-definition]
This field indicates that a second TQ1 segment is to follow. Refer To link:#HL70472[HL7 Table 0472 – TQ Conjunction ID] in Chapter 2C, Code Tables, for allowed values.
