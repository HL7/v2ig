...
Original Mode - |1.3 2| where the dot and space are locally defined

Enhanced Mode - |^1^3^2| where the standard defines the purpose of the components to enable grouping.
