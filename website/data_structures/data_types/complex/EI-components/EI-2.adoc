...
The assigning authority is a unique identifier of the system (or organization or agency or department) that creates the data. Refer to {{v2-table:0363:Assigning Authority}} for suggested values.
...
By site agreement, implementers may continue to use {{v2-table:0300:Namespace ID}} for the first component
