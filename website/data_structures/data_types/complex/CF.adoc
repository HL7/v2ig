...
The components, primary and alternate, are defined as in the CE data type with the exception of the second, fifth, and eleventh components, which are of the formatted text data type.

The Original Text component applies to the CF as a whole.

FIXME - is there a better example (something more modern or likely to be used)
[er7-example]
