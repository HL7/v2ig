...
The Original Text component applies to the CNE as a whole.

[NOTE]
The presence of multiple sets of equivalent codes in this data type is semantically different from a repetition of a CNE-type field. With repetition, several distinct codes (with distinct meanings) may be transmitted.
