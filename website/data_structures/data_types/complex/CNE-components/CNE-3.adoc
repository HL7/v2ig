...
[datatype-definition]
The third component contains the code for the name of the coding system from which the value in _CNE.1_ is obtained. Refer to {{v2-table:0396:Coding Systems}} in Chapter 2C, Code Tables, for valid values. Each coding system is assigned a unique identifier.
