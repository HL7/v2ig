...
Refer to {{v2-table:0396:Coding System}} in Chapter 2C, section "Coding System Table" for valid values.

Refer to section 2A.2.8.3, "Name of Coding System (ID)" for a discussion of coding system conventions.
