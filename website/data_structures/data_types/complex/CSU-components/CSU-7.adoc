...
[datatype-definition]
Specifies the coding system for the alternate unit of measure. Refer to {{v2-table:0396:Coding System}} in Chapter 2C, section "Coding System Table" for valid values. Analogous to _CSU.4 Unit of Measure Coding System_.
