...
image::blood_product_dispense_message_part1.png[blood_product_dispense_message]
...
NOTE THAT WE ARE MISSING O28, O30 AND O32
...
=== Donation Service (Blood Bank) Transaction Flow Diagram
[v291_section="4.16.1"]
