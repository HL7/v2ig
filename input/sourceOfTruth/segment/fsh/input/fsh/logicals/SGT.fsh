...
* 1 1..1 SI "SGT-1" "For the first segment group transmitted, the sequence number SHALL be 1; for the second , it SHALL be 2; and so on."
...
* 1 ^code.code = #3394
* 2 0..1 ST "SGT-2" "This field contains the name of the segment group."
