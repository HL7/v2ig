...
Id: RQI_I01-C
Title: "HL7 v2 RQI_I01-C Segment Definition"
* ^meta.profile = "http://hl7.org/v2/StructureDefinition/MessageStructure-Profile"
* ^type = "RQI_I01-C"
* ^date = "2025-06-13T21:11:33Z"
* . ^short = "RQI_I01-C"
* . ^definition = "RQI_I01-C Message Structure"
...
* 10-GUARANTOR+INSURANCE 0..1 BackboneElement "GUARANTOR+INSURANCE" "GUARANTOR+INSURANCE"
* 10-GUARANTOR+INSURANCE.1-GT1 0..* http://hl7.org/v2/StructureDefinition/GT1 "Guarantor" "Guarantor"
* 10-GUARANTOR+INSURANCE.1-GT1 ^extension.url = "http://hl7.org/fhir/StructureDefinition/v2-segment-status"
* 10-GUARANTOR+INSURANCE.1-GT1 ^extension.valueCode = #A
* 10-GUARANTOR+INSURANCE.2-INSURANCE 1..* BackboneElement "INSURANCE" "INSURANCE"
* 10-GUARANTOR+INSURANCE.2-INSURANCE.1-IN1 1..1 http://hl7.org/v2/StructureDefinition/IN1 "Insurance" "Insurance"
* 10-GUARANTOR+INSURANCE.2-INSURANCE.1-IN1 ^extension.url = "http://hl7.org/fhir/StructureDefinition/v2-segment-status"
* 10-GUARANTOR+INSURANCE.2-INSURANCE.1-IN1 ^extension.valueCode = #A
* 10-GUARANTOR+INSURANCE.2-INSURANCE.2-IN2 0..1 http://hl7.org/v2/StructureDefinition/IN2 "Insurance Additional Info" "Insurance Additional Info"
* 10-GUARANTOR+INSURANCE.2-INSURANCE.2-IN2 ^extension.url = "http://hl7.org/fhir/StructureDefinition/v2-segment-status"
* 10-GUARANTOR+INSURANCE.2-INSURANCE.2-IN2 ^extension.valueCode = #A
* 10-GUARANTOR+INSURANCE.2-INSURANCE.3-IN3 0..1 http://hl7.org/v2/StructureDefinition/IN3 "Insurance Add'l Info - Cert" "Insurance Add'l Info - Cert"
* 10-GUARANTOR+INSURANCE.2-INSURANCE.3-IN3 ^extension.url = "http://hl7.org/fhir/StructureDefinition/v2-segment-status"
* 10-GUARANTOR+INSURANCE.2-INSURANCE.3-IN3 ^extension.valueCode = #A
