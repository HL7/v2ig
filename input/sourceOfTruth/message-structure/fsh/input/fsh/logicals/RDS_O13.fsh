...
Id: RDS_O13
Title: "HL7 v2 RDS_O13 Segment Definition"
* ^meta.profile = "http://hl7.org/v2/StructureDefinition/MessageStructure-Profile"
* ^type = "RDS_O13"
* ^date = "2025-06-13T21:11:32Z"
* . ^short = "RDS_O13"
* . ^definition = "RDS_O13 Message Structure"
...
* 6-PATIENT.8-NTE 0..* http://hl7.org/v2/StructureDefinition/NTE "Notes and Comments (for PID)" "Notes and Comments (for PID)"
...
* 6-PATIENT.10-PATIENT_VISIT.4-ARV 0..* http://hl7.org/v2/StructureDefinition/ARV "For backwards compatibility only as of V2.9." "For backwards compatibility only as of V2.9."
...
* 7-ORDER.4-ORDER_DETAIL.3-ORDER_DETAIL_SUPPLEMENT.3-COMPONENT 0..* BackboneElement "COMPONENT" "COMPONENT"
* 7-ORDER.4-ORDER_DETAIL.3-ORDER_DETAIL_SUPPLEMENT.3-COMPONENT.1-RXC 1..1 http://hl7.org/v2/StructureDefinition/RXC "Pharmacy/Treatment Component" "Pharmacy/Treatment Component"
* 7-ORDER.4-ORDER_DETAIL.3-ORDER_DETAIL_SUPPLEMENT.3-COMPONENT.1-RXC ^extension.url = "http://hl7.org/fhir/StructureDefinition/v2-segment-status"
* 7-ORDER.4-ORDER_DETAIL.3-ORDER_DETAIL_SUPPLEMENT.3-COMPONENT.1-RXC ^extension.valueCode = #A
* 7-ORDER.4-ORDER_DETAIL.3-ORDER_DETAIL_SUPPLEMENT.3-COMPONENT.2-NTE 0..* http://hl7.org/v2/StructureDefinition/NTE "Notes and Comments (for each RXC)" "Notes and Comments (for each RXC)"
* 7-ORDER.4-ORDER_DETAIL.3-ORDER_DETAIL_SUPPLEMENT.3-COMPONENT.2-NTE ^extension.url = "http://hl7.org/fhir/StructureDefinition/v2-segment-status"
* 7-ORDER.4-ORDER_DETAIL.3-ORDER_DETAIL_SUPPLEMENT.3-COMPONENT.2-NTE ^extension.valueCode = #A
...
* 7-ORDER.5-ENCODING.2-PRT 0..* http://hl7.org/v2/StructureDefinition/PRT "Participation (for RXE)" "Participation (for RXE)"
...
* 7-ORDER.6-RXD 1..1 http://hl7.org/v2/StructureDefinition/RXD "Pharmacy/Treatment Dispense" "Pharmacy/Treatment Dispense"
* 7-ORDER.6-RXD ^extension.url = "http://hl7.org/fhir/StructureDefinition/v2-segment-status"
* 7-ORDER.6-RXD ^extension.valueCode = #A
* 7-ORDER.7-PRT 0..* http://hl7.org/v2/StructureDefinition/PRT "Participation (for Treatment Dispense)" "Participation (for Treatment Dispense)"
* 7-ORDER.7-PRT ^extension.url = "http://hl7.org/fhir/StructureDefinition/v2-segment-status"
* 7-ORDER.7-PRT ^extension.valueCode = #A
* 7-ORDER.8-NTE 0..* http://hl7.org/v2/StructureDefinition/NTE "Notes and Comments (for RXD)" "Notes and Comments (for RXD)"
* 7-ORDER.8-NTE ^extension.url = "http://hl7.org/fhir/StructureDefinition/v2-segment-status"
* 7-ORDER.8-NTE ^extension.valueCode = #A
* 7-ORDER.9-RXR 1..* http://hl7.org/v2/StructureDefinition/RXR "Pharmacy/Treatment Route" "Pharmacy/Treatment Route"
* 7-ORDER.9-RXR ^extension.url = "http://hl7.org/fhir/StructureDefinition/v2-segment-status"
* 7-ORDER.9-RXR ^extension.valueCode = #A
* 7-ORDER.10-RXC 0..* http://hl7.org/v2/StructureDefinition/RXC "Pharmacy/Treatment Component" "Pharmacy/Treatment Component"
* 7-ORDER.10-RXC ^extension.url = "http://hl7.org/fhir/StructureDefinition/v2-segment-status"
* 7-ORDER.10-RXC ^extension.valueCode = #A
* 7-ORDER.11-CDO 0..* http://hl7.org/v2/StructureDefinition/CDO "Cumulative Dosage Segment" "Cumulative Dosage Segment"
* 7-ORDER.11-CDO ^extension.url = "http://hl7.org/fhir/StructureDefinition/v2-segment-status"
* 7-ORDER.11-CDO ^extension.valueCode = #A
* 7-ORDER.12-OBSERVATION 0..* BackboneElement "OBSERVATION" "OBSERVATION"
* 7-ORDER.12-OBSERVATION.1-OBX 1..1 http://hl7.org/v2/StructureDefinition/OBX "Results" "Results"
* 7-ORDER.12-OBSERVATION.1-OBX ^extension.url = "http://hl7.org/fhir/StructureDefinition/v2-segment-status"
* 7-ORDER.12-OBSERVATION.1-OBX ^extension.valueCode = #A
* 7-ORDER.12-OBSERVATION.2-PRT 0..* http://hl7.org/v2/StructureDefinition/PRT "Participation (for OBX)" "Participation (for OBX)"
* 7-ORDER.12-OBSERVATION.2-PRT ^extension.url = "http://hl7.org/fhir/StructureDefinition/v2-segment-status"
* 7-ORDER.12-OBSERVATION.2-PRT ^extension.valueCode = #A
* 7-ORDER.12-OBSERVATION.3-NTE 0..* http://hl7.org/v2/StructureDefinition/NTE "Notes and Comments (for OBX)" "Notes and Comments (for OBX)"
* 7-ORDER.12-OBSERVATION.3-NTE ^extension.url = "http://hl7.org/fhir/StructureDefinition/v2-segment-status"
* 7-ORDER.12-OBSERVATION.3-NTE ^extension.valueCode = #A
* 7-ORDER.13-FT1 0..* http://hl7.org/v2/StructureDefinition/FT1 "Financial Transaction segment" "Financial Transaction segment"
* 7-ORDER.13-FT1 ^extension.url = "http://hl7.org/fhir/StructureDefinition/v2-segment-status"
* 7-ORDER.13-FT1 ^extension.valueCode = #A