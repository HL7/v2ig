...
Id: RDE_O11-A
Title: "HL7 v2 RDE_O11-A Segment Definition"
* ^meta.profile = "http://hl7.org/v2/StructureDefinition/MessageStructure-Profile"
* ^type = "RDE_O11-A"
* ^date = "2025-06-13T21:11:32Z"
* . ^short = "RDE_O11-A"
* . ^definition = "RDE_O11-A Message Structure"
...
* 6-PATIENT.5-GSC 0..* http://hl7.org/v2/StructureDefinition/GSC "Sex Parameter for Clinical UseSex Parameter for Clinical Use" "Sex Parameter for Clinical UseSex Parameter for Clinical Use"
...
* 7-ORDER.4-ORDER_DETAIL.5-COMPONENT 0..* BackboneElement "COMPONENT" "COMPONENT"
* 7-ORDER.4-ORDER_DETAIL.5-COMPONENT.1-RXC 1..1 http://hl7.org/v2/StructureDefinition/RXC "Pharmacy/Treatment Component (for RXO)" "Pharmacy/Treatment Component (for RXO)"
* 7-ORDER.4-ORDER_DETAIL.5-COMPONENT.1-RXC ^extension.url = "http://hl7.org/fhir/StructureDefinition/v2-segment-status"
* 7-ORDER.4-ORDER_DETAIL.5-COMPONENT.1-RXC ^extension.valueCode = #A
* 7-ORDER.4-ORDER_DETAIL.5-COMPONENT.2-NTE 0..* http://hl7.org/v2/StructureDefinition/NTE "Notes and Comments (for each RXC)" "Notes and Comments (for each RXC)"
* 7-ORDER.4-ORDER_DETAIL.5-COMPONENT.2-NTE ^extension.url = "http://hl7.org/fhir/StructureDefinition/v2-segment-status"
* 7-ORDER.4-ORDER_DETAIL.5-COMPONENT.2-NTE ^extension.valueCode = #A
...
* 7-ORDER.13-OBSERVATION.2-PRT 0..* http://hl7.org/v2/StructureDefinition/PRT "Participation (for Observation)" "Participation (for Observation)"
