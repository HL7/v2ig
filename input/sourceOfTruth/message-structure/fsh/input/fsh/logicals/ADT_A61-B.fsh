...
Id: ADT_A61-B
Title: "HL7 v2 ADT_A61-B Segment Definition"
* ^meta.profile = "http://hl7.org/v2/StructureDefinition/MessageStructure-Profile"
* ^type = "ADT_A61-B"
* ^date = "2025-06-13T21:11:31Z"
* . ^short = "ADT_A61-B"
* . ^definition = "ADT_A61-B Message Structure"
...
* 14-ROL 0..* http://hl7.org/v2/StructureDefinition/ROL "Role" "Role"
* 14-ROL ^extension.url = "http://hl7.org/fhir/StructureDefinition/v2-segment-status"
* 14-ROL ^extension.valueCode = #B
...
* 16-PV2 0..1 http://hl7.org/v2/StructureDefinition/PV2 "Patient Visit - Additional Info." "Patient Visit - Additional Info."
* 16-PV2 ^extension.url = "http://hl7.org/fhir/StructureDefinition/v2-segment-status"
* 16-PV2 ^extension.valueCode = #A