...
Id: BRT_O32
Title: "HL7 v2 BRT_O32 Segment Definition"
* ^meta.profile = "http://hl7.org/v2/StructureDefinition/MessageStructure-Profile"
* ^type = "BRT_O32"
* ^date = "2025-06-13T21:11:32Z"
* . ^short = "BRT_O32"
* . ^definition = "BRT_O32 Message Structure"
...
* 8-RESPONSE.1-PATIENT.3-ARV 0..* http://hl7.org/v2/StructureDefinition/ARV "For backwards compatbility only as of V2.9." "For backwards compatbility only as of V2.9."
...
* 8-RESPONSE.2-ORDER.4-BPO 0..1 http://hl7.org/v2/StructureDefinition/BPO "Blood Product Order" "Blood Product Order"
* 8-RESPONSE.2-ORDER.4-BPO ^extension.url = "http://hl7.org/fhir/StructureDefinition/v2-segment-status"
* 8-RESPONSE.2-ORDER.4-BPO ^extension.valueCode = #A
* 8-RESPONSE.2-ORDER.5-BTX 0..* http://hl7.org/v2/StructureDefinition/BTX "Blood Product Transfusion/Disposition Status" "Blood Product Transfusion/Disposition Status"
* 8-RESPONSE.2-ORDER.5-BTX ^extension.url = "http://hl7.org/fhir/StructureDefinition/v2-segment-status"
* 8-RESPONSE.2-ORDER.5-BTX ^extension.valueCode = #A