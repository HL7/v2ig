...
Id: ORU_R30-A
Title: "HL7 v2 ORU_R30-A Segment Definition"
* ^meta.profile = "http://hl7.org/v2/StructureDefinition/MessageStructure-Profile"
* ^type = "ORU_R30-A"
* ^date = "2025-06-13T21:11:33Z"
* . ^short = "ORU_R30-A"
* . ^definition = "ORU_R30-A Message Structure"
...
* 22-PRT 0..* http://hl7.org/v2/StructureDefinition/PRT "Participation (for observation)" "Participation (for observation)"
...
* 24-OBSERVATION.2-PRT 0..* http://hl7.org/v2/StructureDefinition/PRT "Participation (for Observation)" "Participation (for Observation)"
