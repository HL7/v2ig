...
Id: RSP_K11
Title: "HL7 v2 RSP_K11 Segment Definition"
* ^meta.profile = "http://hl7.org/v2/StructureDefinition/MessageStructure-Profile"
* ^type = "RSP_K11"
* ^date = "2025-06-13T21:11:32Z"
* . ^short = "RSP_K11"
* . ^definition = "RSP_K11 Message Structure"
...
* 8-SEGMENT_PATTERN 0..1 BackboneElement "SEGMENT_PATTERN" "SEGMENT_PATTERN"
* 8-SEGMENT_PATTERN.1-... 1..1 http://hl7.org/v2/StructureDefinition/...
* 8-SEGMENT_PATTERN.1-... ^extension.url = "http://hl7.org/fhir/StructureDefinition/v2-segment-status"
* 8-SEGMENT_PATTERN.1-... ^extension.valueCode = #A
