...
Id: ADT_A03
Title: "HL7 v2 ADT_A03 Segment Definition"
* ^meta.profile = "http://hl7.org/v2/StructureDefinition/MessageStructure-Profile"
* ^type = "ADT_A03"
* ^date = "2025-06-13T21:11:30Z"
* . ^short = "ADT_A03"
* . ^definition = "ADT_A03 Message Structure"
...
* 25-AL1 0..* http://hl7.org/v2/StructureDefinition/AL1 "Allergy Information" "Allergy Information"
* 25-AL1 ^extension.url = "http://hl7.org/fhir/StructureDefinition/v2-segment-status"
* 25-AL1 ^extension.valueCode = #A
* 26-IAM 0..* http://hl7.org/v2/StructureDefinition/IAM "Patient Adverse Event Reaction Information" "Patient Adverse Event Reaction Information"
* 26-IAM ^extension.url = "http://hl7.org/fhir/StructureDefinition/v2-segment-status"
* 26-IAM ^extension.valueCode = #A
* 27-DG1 0..* http://hl7.org/v2/StructureDefinition/DG1 "Diagnosis Information" "Diagnosis Information"
* 27-DG1 ^extension.url = "http://hl7.org/fhir/StructureDefinition/v2-segment-status"
* 27-DG1 ^extension.valueCode = #A
* 28-DRG 0..1 http://hl7.org/v2/StructureDefinition/DRG "Diagnosis Related Group" "Diagnosis Related Group"
* 28-DRG ^extension.url = "http://hl7.org/fhir/StructureDefinition/v2-segment-status"
* 28-DRG ^extension.valueCode = #A
* 29-PROCEDURE 0..* BackboneElement "PROCEDURE" "PROCEDURE"
* 29-PROCEDURE.1-PR1 1..1 http://hl7.org/v2/StructureDefinition/PR1 "Procedures" "Procedures"
* 29-PROCEDURE.1-PR1 ^extension.url = "http://hl7.org/fhir/StructureDefinition/v2-segment-status"
* 29-PROCEDURE.1-PR1 ^extension.valueCode = #A
* 29-PROCEDURE.2-ROL 0..* http://hl7.org/v2/StructureDefinition/ROL "Role" "Role"
* 29-PROCEDURE.2-ROL ^extension.url = "http://hl7.org/fhir/StructureDefinition/v2-segment-status"
* 29-PROCEDURE.2-ROL ^extension.valueCode = #B
* 29-PROCEDURE.3-PRT 0..* http://hl7.org/v2/StructureDefinition/PRT "Participation" "Participation"
* 29-PROCEDURE.3-PRT ^extension.url = "http://hl7.org/fhir/StructureDefinition/v2-segment-status"
* 29-PROCEDURE.3-PRT ^extension.valueCode = #A
* 30-OBSERVATION 0..* BackboneElement "OBSERVATION" "OBSERVATION"
* 30-OBSERVATION.1-OBX 1..1 http://hl7.org/v2/StructureDefinition/OBX "Observation/Result" "Observation/Result"
* 30-OBSERVATION.1-OBX ^extension.url = "http://hl7.org/fhir/StructureDefinition/v2-segment-status"
* 30-OBSERVATION.1-OBX ^extension.valueCode = #A
* 30-OBSERVATION.2-PRT 0..* http://hl7.org/v2/StructureDefinition/PRT "Participation" "Participation"
* 30-OBSERVATION.2-PRT ^extension.url = "http://hl7.org/fhir/StructureDefinition/v2-segment-status"
* 30-OBSERVATION.2-PRT ^extension.valueCode = #A
...
* 34-INSURANCE.4-GT1 0..* http://hl7.org/v2/StructureDefinition/GT1 "Guarantor" "Guarantor"
* 34-INSURANCE.4-GT1 ^extension.url = "http://hl7.org/fhir/StructureDefinition/v2-segment-status"
* 34-INSURANCE.4-GT1 ^extension.valueCode = #A
* 34-INSURANCE.5-GSP 0..* http://hl7.org/v2/StructureDefinition/GSP "Person Gender and Sex" "Person Gender and Sex"
* 34-INSURANCE.5-GSP ^extension.url = "http://hl7.org/fhir/StructureDefinition/v2-segment-status"
* 34-INSURANCE.5-GSP ^extension.valueCode = #A
* 34-INSURANCE.6-ROL 0..* http://hl7.org/v2/StructureDefinition/ROL "Deprecated as of V2.9" "Deprecated as of V2.9"
...
* 36-PDA 0..1 http://hl7.org/v2/StructureDefinition/PDA "Patient Death and Autopsy" "Patient Death and Autopsy"
* 36-PDA ^extension.url = "http://hl7.org/fhir/StructureDefinition/v2-segment-status"
* 36-PDA ^extension.valueCode = #A