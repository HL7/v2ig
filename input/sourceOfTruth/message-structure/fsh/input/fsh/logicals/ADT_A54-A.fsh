...
Id: ADT_A54-A
Title: "HL7 v2 ADT_A54-A Segment Definition"
* ^meta.profile = "http://hl7.org/v2/StructureDefinition/MessageStructure-Profile"
* ^type = "ADT_A54-A"
* ^date = "2025-06-13T21:11:31Z"
* . ^short = "ADT_A54-A"
* . ^definition = "ADT_A54-A Message Structure"
...
* 13-PV1 1..1 http://hl7.org/v2/StructureDefinition/PV1 "Patient Visit" "Patient Visit"
* 13-PV1 ^extension.url = "http://hl7.org/fhir/StructureDefinition/v2-segment-status"
* 13-PV1 ^extension.valueCode = #A
* 14-PV2 0..1 http://hl7.org/v2/StructureDefinition/PV2 "Patient Visit - Additional Info." "Patient Visit - Additional Info."
* 14-PV2 ^extension.url = "http://hl7.org/fhir/StructureDefinition/v2-segment-status"
* 14-PV2 ^extension.valueCode = #A
* 15-ROL 0..* http://hl7.org/v2/StructureDefinition/ROL "Role" "Role"
* 15-ROL ^extension.url = "http://hl7.org/fhir/StructureDefinition/v2-segment-status"
* 15-ROL ^extension.valueCode = #B
* 16-PRT 0..* http://hl7.org/v2/StructureDefinition/PRT "Participation" "Participation"
* 16-PRT ^extension.url = "http://hl7.org/fhir/StructureDefinition/v2-segment-status"
* 16-PRT ^extension.valueCode = #A