...
Id: RRE_O50
Title: "HL7 v2 RRE_O50 Segment Definition"
* ^meta.profile = "http://hl7.org/v2/StructureDefinition/MessageStructure-Profile"
* ^type = "RRE_O50"
* ^date = "2025-06-13T21:11:32Z"
* . ^short = "RRE_O50"
* . ^definition = "RRE_O50 Message Structure"
...
* 7-RESPONSE.2-ORDER.2-PRT 0..* http://hl7.org/v2/StructureDefinition/PRT "Participation" "Participation"
...
* 7-RESPONSE.2-ORDER.4-ENCODING.2-PRT 0..* http://hl7.org/v2/StructureDefinition/PRT "Participation" "Participation"
...
* 7-RESPONSE.2-ORDER.5-PRT 0..* http://hl7.org/v2/StructureDefinition/PRT "Participation (for Order)" "Participation (for Order)"
* 7-RESPONSE.2-ORDER.5-PRT ^extension.url = "http://hl7.org/fhir/StructureDefinition/v2-segment-status"
* 7-RESPONSE.2-ORDER.5-PRT ^extension.valueCode = #D