...
Id: ADT_A45
Title: "HL7 v2 ADT_A45 Segment Definition"
* ^meta.profile = "http://hl7.org/v2/StructureDefinition/MessageStructure-Profile"
* ^type = "ADT_A45"
* ^date = "2025-06-13T21:11:31Z"
* . ^short = "ADT_A45"
* . ^definition = "ADT_A45 Message Structure"
...
* 11-MERGE_INFO 1..* BackboneElement "MERGE_INFO" "MERGE_INFO"
* 11-MERGE_INFO.1-MRG 1..1 http://hl7.org/v2/StructureDefinition/MRG "Merge Information" "Merge Information"
* 11-MERGE_INFO.1-MRG ^extension.url = "http://hl7.org/fhir/StructureDefinition/v2-segment-status"
* 11-MERGE_INFO.1-MRG ^extension.valueCode = #A
* 11-MERGE_INFO.2-PV1 1..1 http://hl7.org/v2/StructureDefinition/PV1 "Patient Visit" "Patient Visit"
* 11-MERGE_INFO.2-PV1 ^extension.url = "http://hl7.org/fhir/StructureDefinition/v2-segment-status"
* 11-MERGE_INFO.2-PV1 ^extension.valueCode = #A