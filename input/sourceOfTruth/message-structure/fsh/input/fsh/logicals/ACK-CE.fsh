...
Id: ACK-CE
Title: "HL7 v2 ACK-CE Segment Definition"
* ^meta.profile = "http://hl7.org/v2/StructureDefinition/MessageStructure-Profile"
* ^type = "ACK-CE"
* ^date = "2025-06-13T21:11:30Z"
* . ^short = "ACK-CE"
* . ^definition = "ACK-CE Message Structure"
...
* 5-ERR 0..* http://hl7.org/v2/StructureDefinition/ERR "Errorfootnote:[This error segment indicates the fields that caused a transaction to be rejected.]" "Errorfootnote:[This error segment indicates the fields that caused a transaction to be rejected.]"
