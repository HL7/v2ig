...
Id: OML_O21
Title: "HL7 v2 OML_O21 Segment Definition"
* ^meta.profile = "http://hl7.org/v2/StructureDefinition/MessageStructure-Profile"
* ^type = "OML_O21"
* ^date = "2025-06-13T21:11:31Z"
* . ^short = "OML_O21"
* . ^definition = "OML_O21 Message Structure"
...
* 7-ORDER.5-OBSERVATION_REQUEST.12-PRIOR_RESULT.1-PATIENT_PRIOR.7-ARV 0..* http://hl7.org/v2/StructureDefinition/ARV "For backwards compatibility only as of V2.9." "For backwards compatibility only as of V2.9."
* 7-ORDER.5-OBSERVATION_REQUEST.12-PRIOR_RESULT.1-PATIENT_PRIOR.7-ARV ^extension.url = "http://hl7.org/fhir/StructureDefinition/v2-segment-status"
* 7-ORDER.5-OBSERVATION_REQUEST.12-PRIOR_RESULT.1-PATIENT_PRIOR.7-ARV ^extension.valueCode = #B
...
* 7-ORDER.5-OBSERVATION_REQUEST.12-PRIOR_RESULT.4-ORDER_PRIOR.5-OBSERVATION_PARTICIPATION_PRIOR.2-DEV 0..* http://hl7.org/v2/StructureDefinition/DEV "DESCRIPTION NEEDED" "DESCRIPTION NEEDED"
