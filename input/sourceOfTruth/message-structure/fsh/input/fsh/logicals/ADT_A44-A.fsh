...
Id: ADT_A44-A
Title: "HL7 v2 ADT_A44-A Segment Definition"
* ^meta.profile = "http://hl7.org/v2/StructureDefinition/MessageStructure-Profile"
* ^type = "ADT_A44-A"
* ^date = "2025-06-13T21:11:31Z"
* . ^short = "ADT_A44-A"
* . ^definition = "ADT_A44-A Message Structure"
...
* 6-PATIENT.6-ARV 0..* http://hl7.org/v2/StructureDefinition/ARV "Access Restrictions" "Access Restrictions"
* 6-PATIENT.6-ARV ^extension.url = "http://hl7.org/fhir/StructureDefinition/v2-segment-status"
* 6-PATIENT.6-ARV ^extension.valueCode = #B
* 6-PATIENT.7-MRG 1..1 http://hl7.org/v2/StructureDefinition/MRG "Merge Information" "Merge Information"
* 6-PATIENT.7-MRG ^extension.url = "http://hl7.org/fhir/StructureDefinition/v2-segment-status"
* 6-PATIENT.7-MRG ^extension.valueCode = #A