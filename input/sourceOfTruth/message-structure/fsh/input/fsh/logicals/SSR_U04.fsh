...
Id: SSR_U04
Title: "HL7 v2 SSR_U04 Segment Definition"
* ^meta.profile = "http://hl7.org/v2/StructureDefinition/MessageStructure-Profile"
* ^type = "SSR_U04"
* ^date = "2025-06-13T21:11:37Z"
* . ^short = "SSR_U04"
* . ^definition = "SSR_U04 Message Structure"
...
* 5-SPECIMEN_CONTAINER.2-SPM 1..* http://hl7.org/v2/StructureDefinition/SPM "Specimen" "Specimen"
* 5-SPECIMEN_CONTAINER.2-SPM ^extension.url = "http://hl7.org/fhir/StructureDefinition/v2-segment-status"
* 5-SPECIMEN_CONTAINER.2-SPM ^extension.valueCode = #A
