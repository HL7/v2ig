...
Id: BAR_P10
Title: "HL7 v2 BAR_P10 Segment Definition"
* ^meta.profile = "http://hl7.org/v2/StructureDefinition/MessageStructure-Profile"
* ^type = "BAR_P10"
* ^date = "2025-06-13T21:11:32Z"
* . ^short = "BAR_P10"
* . ^definition = "BAR_P10 Message Structure"
...
* 9-GP1 1..1 http://hl7.org/v2/StructureDefinition/GP1 "Grouping/Reimbursement - Visit" "Grouping/Reimbursement - Visit"
* 9-GP1 ^extension.url = "http://hl7.org/fhir/StructureDefinition/v2-segment-status"
* 9-GP1 ^extension.valueCode = #A
...
* 10-PROCEDURE.2-GP2 0..1 http://hl7.org/v2/StructureDefinition/GP2 "Grouping/reimbursement - Procedure" "Grouping/reimbursement - Procedure"
* 10-PROCEDURE.2-GP2 ^extension.url = "http://hl7.org/fhir/StructureDefinition/v2-segment-status"
* 10-PROCEDURE.2-GP2 ^extension.valueCode = #A