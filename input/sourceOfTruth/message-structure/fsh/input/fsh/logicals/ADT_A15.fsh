...
Id: ADT_A15
Title: "HL7 v2 ADT_A15 Segment Definition"
* ^meta.profile = "http://hl7.org/v2/StructureDefinition/MessageStructure-Profile"
* ^type = "ADT_A15"
* ^date = "2025-06-13T21:11:30Z"
* . ^short = "ADT_A15"
* . ^definition = "ADT_A15 Message Structure"
...
* 11-ARV 0..* http://hl7.org/v2/StructureDefinition/ARV "Access Restrictions" "Access Restrictions"
* 11-ARV ^extension.url = "http://hl7.org/fhir/StructureDefinition/v2-segment-status"
* 11-ARV ^extension.valueCode = #B
...
* 14-PV1 1..1 http://hl7.org/v2/StructureDefinition/PV1 "Patient Visit" "Patient Visit"
* 14-PV1 ^extension.url = "http://hl7.org/fhir/StructureDefinition/v2-segment-status"
* 14-PV1 ^extension.valueCode = #A
* 15-PV2 0..1 http://hl7.org/v2/StructureDefinition/PV2 "Patient Visit - Additional Info." "Patient Visit - Additional Info."
* 15-PV2 ^extension.url = "http://hl7.org/fhir/StructureDefinition/v2-segment-status"
* 15-PV2 ^extension.valueCode = #A
* 16-ARV 0..* http://hl7.org/v2/StructureDefinition/ARV "Access Restrictions" "Access Restrictions"
* 16-ARV ^extension.url = "http://hl7.org/fhir/StructureDefinition/v2-segment-status"
* 16-ARV ^extension.valueCode = #B
* 17-ROL 0..* http://hl7.org/v2/StructureDefinition/ROL "Role" "Role"
* 17-ROL ^extension.url = "http://hl7.org/fhir/StructureDefinition/v2-segment-status"
* 17-ROL ^extension.valueCode = #B
* 18-PRT 1..* http://hl7.org/v2/StructureDefinition/PRT "Participation" "Participation"
* 18-PRT ^extension.url = "http://hl7.org/fhir/StructureDefinition/v2-segment-status"
* 18-PRT ^extension.valueCode = #A
...
* 20-OBSERVATION.1-OBX 1..1 http://hl7.org/v2/StructureDefinition/OBX "Observation/Result" "Observation/Result"
* 20-OBSERVATION.1-OBX ^extension.url = "http://hl7.org/fhir/StructureDefinition/v2-segment-status"
* 20-OBSERVATION.1-OBX ^extension.valueCode = #A
