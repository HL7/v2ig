...
Id: ACK-BY
Title: "HL7 v2 ACK-BY Segment Definition"
* ^meta.profile = "http://hl7.org/v2/StructureDefinition/MessageStructure-Profile"
* ^type = "ACK-BY"
* ^date = "2025-06-13T21:11:30Z"
* . ^short = "ACK-BY"
* . ^definition = "ACK-BY Message Structure"
...
* 3-UAC 0..* http://hl7.org/v2/StructureDefinition/UAC "User Authentication Credential Segment" "User Authentication Credential Segment"
...
* 5-ERR 0..* http://hl7.org/v2/StructureDefinition/ERR "Error Information" "Error Information"
