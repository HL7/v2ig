...
Id: RGV_O15
Title: "HL7 v2 RGV_O15 Segment Definition"
* ^meta.profile = "http://hl7.org/v2/StructureDefinition/MessageStructure-Profile"
* ^type = "RGV_O15"
* ^date = "2025-06-13T21:11:32Z"
* . ^short = "RGV_O15"
* . ^definition = "RGV_O15 Message Structure"
...
* 6-PATIENT.2-GSP 0..* http://hl7.org/v2/StructureDefinition/GSP "Person Gender and Sex" "Person Gender and Sex"
* 6-PATIENT.2-GSP ^extension.url = "http://hl7.org/fhir/StructureDefinition/v2-segment-status"
* 6-PATIENT.2-GSP ^extension.valueCode = #A
* 6-PATIENT.3-GSR 0..* http://hl7.org/v2/StructureDefinition/GSR "Recorded Gender and Sex" "Recorded Gender and Sex"
* 6-PATIENT.3-GSR ^extension.url = "http://hl7.org/fhir/StructureDefinition/v2-segment-status"
* 6-PATIENT.3-GSR ^extension.valueCode = #A
* 6-PATIENT.4-GSC 0..* http://hl7.org/v2/StructureDefinition/GSC "Sex Parameter for Clinical Use" "Sex Parameter for Clinical Use"
* 6-PATIENT.4-GSC ^extension.url = "http://hl7.org/fhir/StructureDefinition/v2-segment-status"
* 6-PATIENT.4-GSC ^extension.valueCode = #A
* 6-PATIENT.5-PRT 0..* http://hl7.org/v2/StructureDefinition/PRT "Participation" "Participation"
...
* 6-PATIENT.6-NTE 0..* http://hl7.org/v2/StructureDefinition/NTE "Notes and Comments (for PID)" "Notes and Comments (for PID)"
* 6-PATIENT.6-NTE ^extension.url = "http://hl7.org/fhir/StructureDefinition/v2-segment-status"
* 6-PATIENT.6-NTE ^extension.valueCode = #A
* 6-PATIENT.7-AL1 0..* http://hl7.org/v2/StructureDefinition/AL1 "Allergy Information" "Allergy Information"
* 6-PATIENT.7-AL1 ^extension.url = "http://hl7.org/fhir/StructureDefinition/v2-segment-status"
* 6-PATIENT.7-AL1 ^extension.valueCode = #A
...
* 7-ORDER.6-GIVE 1..* BackboneElement "GIVE" "GIVE"
* 7-ORDER.6-GIVE.1-RXG 1..1 http://hl7.org/v2/StructureDefinition/RXG "Pharmacy/Treatment Give" "Pharmacy/Treatment Give"
* 7-ORDER.6-GIVE.1-RXG ^extension.url = "http://hl7.org/fhir/StructureDefinition/v2-segment-status"
* 7-ORDER.6-GIVE.1-RXG ^extension.valueCode = #A
* 7-ORDER.6-GIVE.2-PRT 0..* http://hl7.org/v2/StructureDefinition/PRT "Participation" "Participation"
* 7-ORDER.6-GIVE.2-PRT ^extension.url = "http://hl7.org/fhir/StructureDefinition/v2-segment-status"
* 7-ORDER.6-GIVE.2-PRT ^extension.valueCode = #A
* 7-ORDER.6-GIVE.3-TIMING_GIVE 1..* BackboneElement "TIMING_GIVE" "TIMING_GIVE"
* 7-ORDER.6-GIVE.3-TIMING_GIVE.1-TQ1 1..1 http://hl7.org/v2/StructureDefinition/TQ1 "Timing/Quantity" "Timing/Quantity"
* 7-ORDER.6-GIVE.3-TIMING_GIVE.1-TQ1 ^extension.url = "http://hl7.org/fhir/StructureDefinition/v2-segment-status"
* 7-ORDER.6-GIVE.3-TIMING_GIVE.1-TQ1 ^extension.valueCode = #A
* 7-ORDER.6-GIVE.3-TIMING_GIVE.2-TQ2 0..* http://hl7.org/v2/StructureDefinition/TQ2 "Timing/Quantity Order Sequence" "Timing/Quantity Order Sequence"
* 7-ORDER.6-GIVE.3-TIMING_GIVE.2-TQ2 ^extension.url = "http://hl7.org/fhir/StructureDefinition/v2-segment-status"
* 7-ORDER.6-GIVE.3-TIMING_GIVE.2-TQ2 ^extension.valueCode = #A
* 7-ORDER.6-GIVE.4-RXR 1..* http://hl7.org/v2/StructureDefinition/RXR "Pharmacy/Treatment Route" "Pharmacy/Treatment Route"
* 7-ORDER.6-GIVE.4-RXR ^extension.url = "http://hl7.org/fhir/StructureDefinition/v2-segment-status"
* 7-ORDER.6-GIVE.4-RXR ^extension.valueCode = #A
* 7-ORDER.6-GIVE.5-RXC 0..* http://hl7.org/v2/StructureDefinition/RXC "Pharmacy/Treatment Component" "Pharmacy/Treatment Component"
* 7-ORDER.6-GIVE.5-RXC ^extension.url = "http://hl7.org/fhir/StructureDefinition/v2-segment-status"
* 7-ORDER.6-GIVE.5-RXC ^extension.valueCode = #A
* 7-ORDER.6-GIVE.6-CDO 0..* http://hl7.org/v2/StructureDefinition/CDO "Cumulative Dosage Segment" "Cumulative Dosage Segment"
* 7-ORDER.6-GIVE.6-CDO ^extension.url = "http://hl7.org/fhir/StructureDefinition/v2-segment-status"
* 7-ORDER.6-GIVE.6-CDO ^extension.valueCode = #A
* 7-ORDER.6-GIVE.7-OBSERVATION 0..* BackboneElement "OBSERVATION" "OBSERVATION"
* 7-ORDER.6-GIVE.7-OBSERVATION.1-OBX 1..1 http://hl7.org/v2/StructureDefinition/OBX "Observation/Results" "Observation/Results"
* 7-ORDER.6-GIVE.7-OBSERVATION.1-OBX ^extension.url = "http://hl7.org/fhir/StructureDefinition/v2-segment-status"
* 7-ORDER.6-GIVE.7-OBSERVATION.1-OBX ^extension.valueCode = #A
* 7-ORDER.6-GIVE.7-OBSERVATION.2-PRT 0..* http://hl7.org/v2/StructureDefinition/PRT "Participation (for Observation)" "Participation (for Observation)"
* 7-ORDER.6-GIVE.7-OBSERVATION.2-PRT ^extension.url = "http://hl7.org/fhir/StructureDefinition/v2-segment-status"
* 7-ORDER.6-GIVE.7-OBSERVATION.2-PRT ^extension.valueCode = #A
* 7-ORDER.6-GIVE.7-OBSERVATION.3-NTE 0..* http://hl7.org/v2/StructureDefinition/NTE "Notes and Comments (for OBX)" "Notes and Comments (for OBX)"
* 7-ORDER.6-GIVE.7-OBSERVATION.3-NTE ^extension.url = "http://hl7.org/fhir/StructureDefinition/v2-segment-status"
* 7-ORDER.6-GIVE.7-OBSERVATION.3-NTE ^extension.valueCode = #A