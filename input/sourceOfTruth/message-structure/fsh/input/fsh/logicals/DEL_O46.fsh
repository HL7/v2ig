...
Id: DEL_O46
Title: "HL7 v2 DEL_O46 Segment Definition"
* ^meta.profile = "http://hl7.org/v2/StructureDefinition/MessageStructure-Profile"
* ^type = "DEL_O46"
* ^date = "2025-06-13T21:11:32Z"
* . ^short = "DEL_O46"
* . ^definition = "DEL_O46 Message Structure"
...
* 6-DON 1..1 http://hl7.org/v2/StructureDefinition/DON "Donation" "Donation"
* 6-DON ^extension.url = "http://hl7.org/fhir/StructureDefinition/v2-segment-status"
* 6-DON ^extension.valueCode = #A
* 7-NTE 0..* http://hl7.org/v2/StructureDefinition/NTE "Notes and Comments (for Donation)" "Notes and Comments (for Donation)"
