...
Id: RSP_Z88
Title: "HL7 v2 RSP_Z88 Segment Definition"
* ^meta.profile = "http://hl7.org/v2/StructureDefinition/MessageStructure-Profile"
* ^type = "RSP_Z88"
* ^date = "2025-06-13T21:11:32Z"
* . ^short = "RSP_Z88"
* . ^definition = "RSP_Z88 Message Structure"
...
* 9-QUERY_RESPONSE.1-PATIENT.4-ALLERGY 0..1 BackboneElement "ALLERGY" "ALLERGY"
* 9-QUERY_RESPONSE.1-PATIENT.4-ALLERGY.1-AL1 1..* http://hl7.org/v2/StructureDefinition/AL1 "Allergy Information" "Allergy Information"
* 9-QUERY_RESPONSE.1-PATIENT.4-ALLERGY.1-AL1 ^extension.url = "http://hl7.org/fhir/StructureDefinition/v2-segment-status"
* 9-QUERY_RESPONSE.1-PATIENT.4-ALLERGY.1-AL1 ^extension.valueCode = #A
* 9-QUERY_RESPONSE.1-PATIENT.4-ALLERGY.2-VISIT 0..1 BackboneElement "VISIT" "VISIT"
* 9-QUERY_RESPONSE.1-PATIENT.4-ALLERGY.2-VISIT.1-PV1 1..1 http://hl7.org/v2/StructureDefinition/PV1 "Patient Visit" "Patient Visit"
* 9-QUERY_RESPONSE.1-PATIENT.4-ALLERGY.2-VISIT.1-PV1 ^extension.url = "http://hl7.org/fhir/StructureDefinition/v2-segment-status"
* 9-QUERY_RESPONSE.1-PATIENT.4-ALLERGY.2-VISIT.1-PV1 ^extension.valueCode = #A
* 9-QUERY_RESPONSE.1-PATIENT.4-ALLERGY.2-VISIT.2-PV2 0..1 http://hl7.org/v2/StructureDefinition/PV2 "Patient Visit – Additional Info" "Patient Visit – Additional Info"
* 9-QUERY_RESPONSE.1-PATIENT.4-ALLERGY.2-VISIT.2-PV2 ^extension.url = "http://hl7.org/fhir/StructureDefinition/v2-segment-status"
* 9-QUERY_RESPONSE.1-PATIENT.4-ALLERGY.2-VISIT.2-PV2 ^extension.valueCode = #A
...
* 9-QUERY_RESPONSE.2-COMMON_ORDER.3-ORDER_DETAIL.4-COMPONENT 0..1 BackboneElement "COMPONENT" "COMPONENT"
* 9-QUERY_RESPONSE.2-COMMON_ORDER.3-ORDER_DETAIL.4-COMPONENT.1-RXC 1..* http://hl7.org/v2/StructureDefinition/RXC "Pharmacy/Treatment Component" "Pharmacy/Treatment Component"
* 9-QUERY_RESPONSE.2-COMMON_ORDER.3-ORDER_DETAIL.4-COMPONENT.1-RXC ^extension.url = "http://hl7.org/fhir/StructureDefinition/v2-segment-status"
* 9-QUERY_RESPONSE.2-COMMON_ORDER.3-ORDER_DETAIL.4-COMPONENT.1-RXC ^extension.valueCode = #A
* 9-QUERY_RESPONSE.2-COMMON_ORDER.3-ORDER_DETAIL.4-COMPONENT.2-NTE 0..* http://hl7.org/v2/StructureDefinition/NTE "Notes and Comments (for RXC)" "Notes and Comments (for RXC)"
* 9-QUERY_RESPONSE.2-COMMON_ORDER.3-ORDER_DETAIL.4-COMPONENT.2-NTE ^extension.url = "http://hl7.org/fhir/StructureDefinition/v2-segment-status"
* 9-QUERY_RESPONSE.2-COMMON_ORDER.3-ORDER_DETAIL.4-COMPONENT.2-NTE ^extension.valueCode = #A
* 9-QUERY_RESPONSE.2-COMMON_ORDER.4-ORDER_ENCODED 0..1 BackboneElement "ORDER_ENCODED" "ORDER_ENCODED"
* 9-QUERY_RESPONSE.2-COMMON_ORDER.4-ORDER_ENCODED.1-RXE 1..1 http://hl7.org/v2/StructureDefinition/RXE "Pharmacy/Treatment Encoded Order" "Pharmacy/Treatment Encoded Order"
* 9-QUERY_RESPONSE.2-COMMON_ORDER.4-ORDER_ENCODED.1-RXE ^extension.url = "http://hl7.org/fhir/StructureDefinition/v2-segment-status"
* 9-QUERY_RESPONSE.2-COMMON_ORDER.4-ORDER_ENCODED.1-RXE ^extension.valueCode = #A
* 9-QUERY_RESPONSE.2-COMMON_ORDER.4-ORDER_ENCODED.2-TIMING_ENCODED 0..* BackboneElement "TIMING_ENCODED" "TIMING_ENCODED"
* 9-QUERY_RESPONSE.2-COMMON_ORDER.4-ORDER_ENCODED.2-TIMING_ENCODED.1-TQ1 1..1 http://hl7.org/v2/StructureDefinition/TQ1 "Timing/Quantity" "Timing/Quantity"
* 9-QUERY_RESPONSE.2-COMMON_ORDER.4-ORDER_ENCODED.2-TIMING_ENCODED.1-TQ1 ^extension.url = "http://hl7.org/fhir/StructureDefinition/v2-segment-status"
* 9-QUERY_RESPONSE.2-COMMON_ORDER.4-ORDER_ENCODED.2-TIMING_ENCODED.1-TQ1 ^extension.valueCode = #A
* 9-QUERY_RESPONSE.2-COMMON_ORDER.4-ORDER_ENCODED.2-TIMING_ENCODED.2-TQ2 0..* http://hl7.org/v2/StructureDefinition/TQ2 "Timing/Quantity Order Sequence" "Timing/Quantity Order Sequence"
* 9-QUERY_RESPONSE.2-COMMON_ORDER.4-ORDER_ENCODED.2-TIMING_ENCODED.2-TQ2 ^extension.url = "http://hl7.org/fhir/StructureDefinition/v2-segment-status"
* 9-QUERY_RESPONSE.2-COMMON_ORDER.4-ORDER_ENCODED.2-TIMING_ENCODED.2-TQ2 ^extension.valueCode = #A
* 9-QUERY_RESPONSE.2-COMMON_ORDER.4-ORDER_ENCODED.3-RXR 1..* http://hl7.org/v2/StructureDefinition/RXR "Pharmacy/Treatment Route" "Pharmacy/Treatment Route"
* 9-QUERY_RESPONSE.2-COMMON_ORDER.4-ORDER_ENCODED.3-RXR ^extension.url = "http://hl7.org/fhir/StructureDefinition/v2-segment-status"
* 9-QUERY_RESPONSE.2-COMMON_ORDER.4-ORDER_ENCODED.3-RXR ^extension.valueCode = #A
* 9-QUERY_RESPONSE.2-COMMON_ORDER.4-ORDER_ENCODED.4-RXC 0..* http://hl7.org/v2/StructureDefinition/RXC "Pharmacy/Treatment Component" "Pharmacy/Treatment Component"
* 9-QUERY_RESPONSE.2-COMMON_ORDER.4-ORDER_ENCODED.4-RXC ^extension.url = "http://hl7.org/fhir/StructureDefinition/v2-segment-status"
* 9-QUERY_RESPONSE.2-COMMON_ORDER.4-ORDER_ENCODED.4-RXC ^extension.valueCode = #A
