...
Id: DBC_O41
Title: "HL7 v2 DBC_O41 Segment Definition"
* ^meta.profile = "http://hl7.org/v2/StructureDefinition/MessageStructure-Profile"
* ^type = "DBC_O41"
* ^date = "2025-06-13T21:11:32Z"
* . ^short = "DBC_O41"
* . ^definition = "DBC_O41 Message Structure"
...
* 5-DONOR.6-ARV 0..* http://hl7.org/v2/StructureDefinition/ARV "For backwards compatibility only as of V2.9." "For backwards compatibility only as of V2.9."
* 5-DONOR.6-ARV ^extension.url = "http://hl7.org/fhir/StructureDefinition/v2-segment-status"
* 5-DONOR.6-ARV ^extension.valueCode = #B
* 5-DONOR.7-AL1 0..* http://hl7.org/v2/StructureDefinition/AL1 "Allergy Information" "Allergy Information"
* 5-DONOR.7-AL1 ^extension.url = "http://hl7.org/fhir/StructureDefinition/v2-segment-status"
* 5-DONOR.7-AL1 ^extension.valueCode = #A