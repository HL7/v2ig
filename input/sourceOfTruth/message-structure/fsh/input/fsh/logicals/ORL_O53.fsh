...
Id: ORL_O53
Title: "HL7 v2 ORL_O53 Segment Definition"
* ^meta.profile = "http://hl7.org/v2/StructureDefinition/MessageStructure-Profile"
* ^type = "ORL_O53"
* ^date = "2025-06-13T21:11:31Z"
* . ^short = "ORL_O53"
* . ^definition = "ORL_O53 Message Structure"
...
* 8-RESPONSE.2-ORDER.2-PRT 0..* http://hl7.org/v2/StructureDefinition/PRT "Participation (for Common Order)" "Participation (for Common Order)"
...
* 8-RESPONSE.2-ORDER.4-OBSERVATION_REQUEST.3-SPECIMEN 0..* BackboneElement "SPECIMEN" "SPECIMEN"
* 8-RESPONSE.2-ORDER.4-OBSERVATION_REQUEST.3-SPECIMEN.1-SPM 1..1 http://hl7.org/v2/StructureDefinition/SPM "Specimen" "Specimen"
* 8-RESPONSE.2-ORDER.4-OBSERVATION_REQUEST.3-SPECIMEN.1-SPM ^extension.url = "http://hl7.org/fhir/StructureDefinition/v2-segment-status"
* 8-RESPONSE.2-ORDER.4-OBSERVATION_REQUEST.3-SPECIMEN.1-SPM ^extension.valueCode = #A
* 8-RESPONSE.2-ORDER.4-OBSERVATION_REQUEST.3-SPECIMEN.2-SAC 0..* http://hl7.org/v2/StructureDefinition/SAC "Specimen Container Details" "Specimen Container Details"
* 8-RESPONSE.2-ORDER.4-OBSERVATION_REQUEST.3-SPECIMEN.2-SAC ^extension.url = "http://hl7.org/fhir/StructureDefinition/v2-segment-status"
* 8-RESPONSE.2-ORDER.4-OBSERVATION_REQUEST.3-SPECIMEN.2-SAC ^extension.valueCode = #A