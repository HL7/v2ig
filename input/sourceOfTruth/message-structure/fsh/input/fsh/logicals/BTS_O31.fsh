...
Id: BTS_O31
Title: "HL7 v2 BTS_O31 Segment Definition"
* ^meta.profile = "http://hl7.org/v2/StructureDefinition/MessageStructure-Profile"
* ^type = "BTS_O31"
* ^date = "2025-06-13T21:11:32Z"
* . ^short = "BTS_O31"
* . ^definition = "BTS_O31 Message Structure"
...
* 6-PATIENT.8-PATIENT_VISIT 0..1 BackboneElement "PATIENT_VISIT" "PATIENT_VISIT"
* 6-PATIENT.8-PATIENT_VISIT.1-PV1 1..1 http://hl7.org/v2/StructureDefinition/PV1 "Patient Visit" "Patient Visit"
* 6-PATIENT.8-PATIENT_VISIT.1-PV1 ^extension.url = "http://hl7.org/fhir/StructureDefinition/v2-segment-status"
* 6-PATIENT.8-PATIENT_VISIT.1-PV1 ^extension.valueCode = #A
* 6-PATIENT.8-PATIENT_VISIT.2-PV2 0..1 http://hl7.org/v2/StructureDefinition/PV2 "Patient Visit – Additional Info" "Patient Visit – Additional Info"
* 6-PATIENT.8-PATIENT_VISIT.2-PV2 ^extension.url = "http://hl7.org/fhir/StructureDefinition/v2-segment-status"
* 6-PATIENT.8-PATIENT_VISIT.2-PV2 ^extension.valueCode = #A
* 6-PATIENT.8-PATIENT_VISIT.3-PRT 0..* http://hl7.org/v2/StructureDefinition/PRT "Participation (for Patient Visit)" "Participation (for Patient Visit)"
* 6-PATIENT.8-PATIENT_VISIT.3-PRT ^extension.url = "http://hl7.org/fhir/StructureDefinition/v2-segment-status"
* 6-PATIENT.8-PATIENT_VISIT.3-PRT ^extension.valueCode = #A
...
* 7-ORDER.6-PRODUCT_STATUS 0..* BackboneElement "PRODUCT_STATUS" "PRODUCT_STATUS"
* 7-ORDER.6-PRODUCT_STATUS.1-BTX 1..1 http://hl7.org/v2/StructureDefinition/BTX "Blood Product Transfusion/Disposition Status" "Blood Product Transfusion/Disposition Status"
* 7-ORDER.6-PRODUCT_STATUS.1-BTX ^extension.url = "http://hl7.org/fhir/StructureDefinition/v2-segment-status"
* 7-ORDER.6-PRODUCT_STATUS.1-BTX ^extension.valueCode = #A
* 7-ORDER.6-PRODUCT_STATUS.2-NTE 0..* http://hl7.org/v2/StructureDefinition/NTE "Notes and Comments (for BTX)" "Notes and Comments (for BTX)"
* 7-ORDER.6-PRODUCT_STATUS.2-NTE ^extension.url = "http://hl7.org/fhir/StructureDefinition/v2-segment-status"
* 7-ORDER.6-PRODUCT_STATUS.2-NTE ^extension.valueCode = #A