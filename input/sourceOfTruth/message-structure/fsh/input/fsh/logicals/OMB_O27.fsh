...
Id: OMB_O27
Title: "HL7 v2 OMB_O27 Segment Definition"
* ^meta.profile = "http://hl7.org/v2/StructureDefinition/MessageStructure-Profile"
* ^type = "OMB_O27"
* ^date = "2025-06-13T21:11:32Z"
* . ^short = "OMB_O27"
* . ^definition = "OMB_O27 Message Structure"
...
* 7-ORDER.3-TIMING.1-TQ1 1..1 http://hl7.org/v2/StructureDefinition/TQ1 "Timing/Quantità" "Timing/Quantità"
...
* 7-ORDER.5-SPM 0..1 http://hl7.org/v2/StructureDefinition/SPM "Specimen" "Specimen"
* 7-ORDER.5-SPM ^extension.url = "http://hl7.org/fhir/StructureDefinition/v2-segment-status"
* 7-ORDER.5-SPM ^extension.valueCode = #A
* 7-ORDER.6-NTE 0..* http://hl7.org/v2/StructureDefinition/NTE "Notes and Comments (for Order)" "Notes and Comments (for Order)"
...
* 7-ORDER.8-OBSERVATION.2-PRT 1..* http://hl7.org/v2/StructureDefinition/PRT "Participation" "Participation"
...
* 7-ORDER.9-FT1 0..* http://hl7.org/v2/StructureDefinition/FT1 "Financial Transaction" "Financial Transaction"
* 7-ORDER.9-FT1 ^extension.url = "http://hl7.org/fhir/StructureDefinition/v2-segment-status"
* 7-ORDER.9-FT1 ^extension.valueCode = #A
* 7-ORDER.10-BLG 0..1 http://hl7.org/v2/StructureDefinition/BLG "Billing Segment" "Billing Segment"
* 7-ORDER.10-BLG ^extension.url = "http://hl7.org/fhir/StructureDefinition/v2-segment-status"
* 7-ORDER.10-BLG ^extension.valueCode = #A