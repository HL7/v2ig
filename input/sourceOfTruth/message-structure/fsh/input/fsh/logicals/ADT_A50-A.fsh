...
Id: ADT_A50-A
Title: "HL7 v2 ADT_A50-A Segment Definition"
* ^meta.profile = "http://hl7.org/v2/StructureDefinition/MessageStructure-Profile"
* ^type = "ADT_A50-A"
* ^date = "2025-06-13T21:11:31Z"
* . ^short = "ADT_A50-A"
* . ^definition = "ADT_A50-A Message Structure"
...
* 11-MRG 1..1 http://hl7.org/v2/StructureDefinition/MRG "Merge Information" "Merge Information"
* 11-MRG ^extension.url = "http://hl7.org/fhir/StructureDefinition/v2-segment-status"
* 11-MRG ^extension.valueCode = #A
* 12-PV1 1..1 http://hl7.org/v2/StructureDefinition/PV1 "Patient Visit" "Patient Visit"
* 12-PV1 ^extension.url = "http://hl7.org/fhir/StructureDefinition/v2-segment-status"
* 12-PV1 ^extension.valueCode = #A