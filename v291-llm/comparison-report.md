...
- Common (extracted in both corpuses): 106
- LLM-only: 2
- python-docx-only: 321
...
- Common occurrence keys: 21
- LLM-only: 0
- python-docx-only: 172
...
- ADD clause=2.14.1 tableIndex=37
...
- BHS clause=2.14.2 tableIndex=38
...
- BTS clause=2.14.3 tableIndex=39
...
- CSP clause=7.8.2 tableIndex=61
- CSR clause=7.8.1 tableIndex=60
