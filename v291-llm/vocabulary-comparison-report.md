...
- Tables identical in every compared field: **739 / 799**
- Tables with at least one real content disagreement: **2**

### Disagreements by kind

| Kind | Count | Meaning |
|---|---:|---|
| `typography` | 211 | LLM substituted an ASCII look-alike; python-docx is character-faithful |
...
| `content` | 2 | Genuine disagreement — examine against the source .docx |
...
| 0964 | `conceptDomain.Description` | content | `Domain of concepts describing reasons why a particular service was performed.\nThis cou...` | `Domain of concepts describing reasons why a particular service was performed.\nThis cou...` |
...
211 values across 43 tables differ only 
