...
* In the General Lab Orders and Results topic, should the Associations between Order Control Codes and Trigger Events table be updated to (1) remove deprecated events such as O01 (2) add all result events (not just R01) (3) include event types that are specifically in this topic (but are in other topics)? Also see the editor's note after the table.
